...
namespace Kolos2.Migrations
{
    ...
    [Migration("20240613122549_FixDataTypeOrderPastry")]
    partial class FixDataTypeOrderPastry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kolos2.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ClientId = 2,
                            EmployeeId = 1,
                            FulfilledAt = new DateTime(2024, 6, 2, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });

            modelBuilder.Entity("Kolos2.Models.OrderPastry", b =>
                {
            ...
            modelBuilder.Entity("Kolos2.Models.Pastry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kolos2.Models.OrderPastry", b =>
                {
                    b.HasOne("Kolos2.Models.Order", "Order")
                        .WithMany("OrderPastries")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kolos2.Models.Pastry", "Pastry")
                        .WithMany("OrderPastries")
